	...
	// input to MAC
	wire [`DATA_WIDTH - 1:0] mult_a_temp_SET_KERNEL_SIZE_FLAG[`PARA_X*`PARA_Y - 1:0];
	generate
		genvar i_SET_KERNEL_SIZE_FLAG_1;
		genvar i_SET_KERNEL_SIZE_FLAG_2;
		for (i_SET_KERNEL_SIZE_FLAG_1 = 0; i_SET_KERNEL_SIZE_FLAG_1 < `PARA_X; i_SET_KERNEL_SIZE_FLAG_1 = i_SET_KERNEL_SIZE_FLAG_1 + 1)
		begin:identifier_SET_KERNEL_SIZE_FLAG_ii1
			for (i_SET_KERNEL_SIZE_FLAG_2 = 0; i_SET_KERNEL_SIZE_FLAG_2 < `PARA_Y; i_SET_KERNEL_SIZE_FLAG_2 = i_SET_KERNEL_SIZE_FLAG_2 + 1)
			begin:identifier_SET_KERNEL_SIZE_FLAG_ii2
				assign mult_a_temp_SET_KERNEL_SIZE_FLAG[(i_SET_KERNEL_SIZE_FLAG_1*`PARA_Y)+i_SET_KERNEL_SIZE_FLAG_2] = register[i_SET_KERNEL_SIZE_FLAG_1][`DATA_WIDTH*(i_SET_KERNEL_SIZE_FLAG_2+SET_KERNEL_SIZE_NUMBER) - 1:`DATA_WIDTH*(i_SET_KERNEL_SIZE_FLAG_2+(SET_KERNEL_SIZE_NUMBER-1))];
			end	
		end
	endgenerate
