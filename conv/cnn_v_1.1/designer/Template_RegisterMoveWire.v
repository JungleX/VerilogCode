	...
	generate
		...
		begin:identifier_SET_KERNEL_SIZE_FLAG_0
			assign register_SET_KERNEL_SIZE_FLAG_0[k_SET_KERNEL_SIZE_FLAG_0][`DATA_WIDTH*(`PARA_Y+2) - 1:`DATA_WIDTH*2] = input_data[`DATA_WIDTH*(k_SET_KERNEL_SIZE_FLAG_0+1)*(`PARA_Y) - 1:`DATA_WIDTH*k_SET_KERNEL_SIZE_FLAG_0*(`PARA_Y)];
		end
	endgenerate
